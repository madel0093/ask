...
class SiteController extends Controller
{
	...
	public function actionDynamicNotification()
	{
		$this->widget('application.extensions.PNotify.PNotify',array('options'=>array('delay'=>0,'opacity'=>1,)));
