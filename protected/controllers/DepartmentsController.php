...
class DepartmentsController extends Controller
{
	...
	{
        $id=Yii::app()->user->getState('DepId');
		$subjectDataProvider=new CActiveDataProvider('Subject' 
			, array(
				'criteria'=>array(
					'condition'=>'DepId=:DepartmentId',
					'params'=>array(':DepartmentId'=>$this->loadModel($id)->DepartmentId),
					'order'=>'year , Term',
					),
				)
			);
